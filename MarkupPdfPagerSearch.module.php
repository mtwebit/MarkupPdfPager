...
class MarkupPdfPagerSearch extends WireData implements Module {
  private $assetsURL;
  private $solr_client;
 ...
 **********************************************************************/
  ...
  public function init() {
	$assetsURL = $this->config->urls->siteModules . 'MarkupPdfPager/assets/';
    // check config
 ...
 **********************************************************************/
  ...
  /**
   * Index a PDF document using Solr
   * 
   * @param $pdfPage ProcessWire Page object (the page contains the PDF file field)
